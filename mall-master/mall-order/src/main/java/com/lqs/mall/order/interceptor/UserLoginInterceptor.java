package com.lqs.mall.order.interceptor;
...
public class UserLoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
         ...
         */
        boolean match = new AntPathMatcher().match("/order/status/**", request.getRequestURI());
        ...
        if (new AntPathMatcher().match("order/return", request.getRequestURI())) {
            return true;
        }
