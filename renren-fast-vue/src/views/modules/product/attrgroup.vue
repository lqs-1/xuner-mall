<template>
  <el-row :gutter="20">
    <el-col :span="6">
      <category @tree-node-click="clickNodeHandler"></category>
    </el-col>
    <el-col :span="18">
        ...
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
          ...
          <el-form-item>
            ...
            <el-button @click="getDataListAll()">查询全部</el-button>
        ...
        <template slot-scope="scope">
          <img :src="scope.row.icon" style="width: 60px; height:40px">
        </template>
          </el-table-column>
          <el-table-column
            prop="catelogId"
...
export default {
  ...
  methods: {
    ...
    // 接收父组件的方法传递的参数
    clickNodeHandler(data, node, component){
      if (data.catLevel == 3){
