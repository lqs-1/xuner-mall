    ...
    getWares() {
      this.$http({
        ...
        if (data.code >= 10000 && data.code < 20000){
          ...
          this.wareList = data.wareList.resultList;
        }else {
      ...
      this.$nextTick(() => {
        ...
        if (this.dataForm.id) {
          this.$http({
            ...
            if (data.code >= 10000 && data.code < 20000){
              this.$message.success(data.msg)
              this.dataForm.purchaseId = data.purchaseNeed.purchaseId;
              this.dataForm.skuId = data.purchaseNeed.skuId;
              this.dataForm.skuNum = data.purchaseNeed.skuNum;
              this.dataForm.skuPrice = data.purchaseNeed.skuPrice;
              this.dataForm.wareId = data.purchaseNeed.wareId;
              this.dataForm.status = data.purchaseNeed.status;
            }else {
              this.$message.error(data.msg)
            }
          });
