...
CREATE TABLE `sms_member_price` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COMMENT='商品会员价格';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_member_price` VALUES (1,32,2,'铜牌会员',2399.0000,1),(2,32,3,'金牌会员',2299.0000,1),(3,33,2,'铜牌会员',2899.0000,1),(4,33,3,'金牌会员',2799.0000,1),(5,34,2,'铜牌会员',2399.0000,1),(6,34,3,'金牌会员',2299.0000,1),(7,35,2,'铜牌会员',2899.0000,1),(8,35,3,'金牌会员',2799.0000,1),(9,36,2,'铜牌会员',2399.0000,1),(10,36,3,'金牌会员',2299.0000,1),(11,37,2,'铜牌会员',2899.0000,1),(12,37,3,'金牌会员',2799.0000,1),(13,38,2,'铜牌会员',5500.0000,1),(14,38,3,'金牌会员',5300.0000,1),(15,39,2,'铜牌会员',5500.0000,1),(16,39,3,'金牌会员',5300.0000,1),(17,40,2,'铜牌会员',4000.0000,1),(18,40,3,'金牌会员',3000.0000,1),(19,41,2,'铜牌会员',4000.0000,1),(20,41,3,'金牌会员',3000.0000,1),(21,42,2,'铜牌会员',4000.0000,1),(22,42,3,'金牌会员',3000.0000,1),(23,43,2,'铜牌会员',4000.0000,1),(24,43,3,'金牌会员',3000.0000,1),(25,44,2,'铜牌会员',4000.0000,1),(26,44,3,'金牌会员',3000.0000,1),(27,45,2,'铜牌会员',4000.0000,1),(28,45,3,'金牌会员',3000.0000,1);
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COMMENT='商品满减信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_sku_full_reduction` VALUES (3,32,5000.0000,200.0000,NULL),(4,33,5000.0000,200.0000,NULL),(5,34,5000.0000,200.0000,NULL),(6,35,5000.0000,200.0000,NULL),(7,36,5000.0000,200.0000,NULL),(8,37,5000.0000,200.0000,NULL),(9,38,10000.0000,100.0000,NULL),(10,39,10000.0000,100.0000,NULL),(11,40,10000.0000,200.0000,NULL),(12,41,10000.0000,200.0000,NULL),(13,42,10000.0000,200.0000,NULL),(14,43,10000.0000,200.0000,NULL),(15,44,10000.0000,200.0000,NULL),(16,45,10000.0000,200.0000,NULL);
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COMMENT='商品阶梯价格';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_sku_ladder` VALUES (3,32,2,0.01,NULL,1),(4,33,2,0.02,NULL,1),(5,34,2,0.01,NULL,1),(6,35,2,0.02,NULL,1),(7,36,2,0.01,NULL,1),(8,37,2,0.02,NULL,1),(9,38,2,0.02,NULL,1),(10,39,2,0.01,NULL,1),(11,40,2,0.01,NULL,1),(12,41,2,0.01,NULL,1),(13,42,2,0.01,NULL,1),(14,43,2,0.01,NULL,1),(15,44,2,0.01,NULL,1),(16,45,2,0.01,NULL,1);
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='商品spu积分设置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_spu_bounds` VALUES (4,NULL,10.0000,10.0000,NULL),(5,NULL,5.0000,4.0000,NULL),(6,NULL,1.0000,1.0000,NULL);
...
-- Dump completed on 2023-01-13  7:55:26
